 ...
 */
export function registerHooks(ctx, { resolveBinding, index, buildBrief, config, capture, queueRoot }) {
  ...
  const captureHooks = capture === undefined || capture === null ? captureFromQueueRoot(ctx, deps, queueRoot) : capture
 ...
 */
function captureFromQueueRoot(ctx, deps, queueRoot) {
