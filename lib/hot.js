...
//     an entry.
//
// The archive note lives at `<project>/文档/热记忆归档.md`: a warm, searchable
...
/** The title (and note name) of the archive note. */
...
export function archivePathFor(binding) {
  return `${projectDirectory(binding)}/文档/${ARCHIVE_TITLE}.md`
}
